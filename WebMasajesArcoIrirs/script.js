document.addEventListener("DOMContentLoaded", function () {
  ...
  prevBtn.addEventListener('click', () => {
      ...
      carrouselImage.style.opacity = 0; // Desvanecer la imagen
      setTimeout(() => {
          carrouselImage.src = images[currentIndex];
          carrouselImage.style.opacity = 1; // Volver a mostrar la imagen
...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.section h3').forEach(header => { // Corregido aquí
